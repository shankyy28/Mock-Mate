...
def extract_technical_skills(resume_tokens):
    ...
    unique_skills = list(set(skills_in_resume))  # Remove duplicates by converting to a set
...
async def upload_resume(file: UploadFile, experience: str = Form(...)):
    ...
    # Example of handling the experience data (could be extended to use it for further processing)
